...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>All Comments</a>
                </li>
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Add New Comment</a>
                </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Add New Role</a>
                </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>Add New User</a>
                </li>
